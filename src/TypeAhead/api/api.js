...
export const getItemsFromAPI = async (apiUrl, inputValue) => {
  // TODO reimplement this logic with real API calls
  // something like /names/?search=al&limit=10
  await new Promise((resolve) => setTimeout(resolve, 500));

  const regex = new RegExp(inputValue, 'i');
  return STATES.filter((suggestion) => regex.test(suggestion.name));
};
